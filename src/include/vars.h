...
extern int  floppy_insert(const char *Image);
...
EXTERNX int16 read_rom(const char *filename, uint8 *ROMMX);
...
#define lisa_io                  24     /* This is a dispatcher for I/O space when we don't know the address */
...
extern CPP2C void messagebox(const char *s, const char *t);
extern CPP2C int yesnomessagebox(const char *s, const char *t);
...
extern int profile_mount(const char *filename, ProFileType *P);

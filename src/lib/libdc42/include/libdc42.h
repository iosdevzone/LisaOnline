...
int dc42_auto_open(DC42ImageType *F, const char *filename, const char *options)                // open a disk image, or a DART image.  If the
...
int dc42_create(const char *filename, const char *volname, uint32 datasize, uint32 tagsize)    // create a blank new disk image

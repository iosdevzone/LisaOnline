...
void init_lisa_mmu(void)
{
    ...
    mem68k_memptr[lisa_io]=lisa_mptr_io;
    mem68k_fetch_byte[lisa_io]=lisa_rb_io;
    mem68k_fetch_word[lisa_io]=lisa_rw_io;
    mem68k_fetch_long[lisa_io]=lisa_rl_io;
    mem68k_store_byte[lisa_io]=lisa_wb_io;
    mem68k_store_word[lisa_io]=lisa_ww_io;
    mem68k_store_long[lisa_io]=lisa_wl_io;
...
void get_slr_page_range(int cx,int seg, int16 *pagestart, int16 *pageend, lisa_mem_t *rfn, lisa_mem_t *wfn)
{
    ...
    switch (slr & FILTR)
    {
     ...
     case SLR_IO_SPACE:         *pagestart=0;        *pageend=page;     *rfn=lisa_io;      *wfn=lisa_io;       return;
